...
.
$
The last inequality can be easily obtained by using the generalization \cite{TenBerge1983} of the Kristof's Theorem \cite{Kristof1970515}. The equality is obtained at 
