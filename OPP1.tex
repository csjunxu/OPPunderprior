...
Since the solution of $\mathbf{\hat{P}}$ is not unique when $\text{rank}(\mathbf{\Sigma})$, we define the set of solutions for in a formal manner and discuss its properties.
