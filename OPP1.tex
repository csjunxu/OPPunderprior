...
In this paper, we studied the classical orthogonal Procrustes problem and gave the solution of a generalized version of the original problem with partially known columns, which included the original orthogonal Procrustes problem as a special case (i.e., when there is no guidance at all). Since the orthogonal Procrustes problem had been generalized to two-sided version \cite{schonemann1968two} and weighted version \cite{Lissitz1976,Koschat1991}, we are highly motivated to study these generalized problems under partially known guidance.
