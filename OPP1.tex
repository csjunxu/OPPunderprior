...
Green \cite{green1952orthogonal} derived the solution of probelm (\ref{e1}) when the matrices $\mathbf{A}$ and $\mathbf{B}$ are of full column rank. Sch{\"o}nemann \cite{schonemann1966generalized} generalized the solution to matrices $\mathbf{A}$ and $\mathbf{B}$ of arbitrary rank.
