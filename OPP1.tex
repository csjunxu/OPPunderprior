...
The classical orthogonal Procrustes problem has been applied in factor analysis and statistics, machine learning, computer vision, optical imaging, and robotics.
...
\textbf{Results 1}: Given partially known prior of $\mathbf{X}^{\top}\mathbf{X}=\mathbf{I}_{p\times p}$, the solution of the following problem
\begin{equation}
