...
\begin{equation}
\mathcal{S}=\{\mathbf{S}\in\mathbb{R}^{n\times q}: \mathbf{S}^{\top}\mathbf{S}=\mathbf{I}_{q\times q}, \|\mathbf{B}-\mathbf{S}\mathbf{A}\|_{F}^{2}=\min_{\mathbf{P}}\|\mathbf{B}-\mathbf{P}\mathbf{A}\|_{F}^{2}\}
\end{equation}
